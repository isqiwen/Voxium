...
int parse(const std::string& project_input_file_name,
          const std::string& source_include_file_name,
...
int main(int argc, char* argv[])
{
    ...
    else
    {
        std::cerr << "Arguments parse error!" << std::endl
                  ...
                  << "VoxiumMetaParser project_file_name include_file_name_to_generate project_base_directory "
