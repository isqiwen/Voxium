...
namespace Utils
{
    ...
    std::string getNameWithoutFirstM(const std::string& name)
    {
    ...
    std::string getNameWithoutContainer(const std::string& name)
    {
    ...
    std::string getStringWithoutQuot(const std::string& input)
    {
    ...
    std::string convertNameToUpperCamelCase(const std::string& name, const std::string& pat)
    {
        std::string ret_string;
