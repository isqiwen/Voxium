...
namespace Voxium::Core
{
    ...
    enum class CORE_API Gravity : unsigned int
    {
        None             = 0x0000,
        Left             = 0x0001,
        Right            = 0x0002,
    ...
    constexpr Gravity operator&(Gravity a, Gravity b) { return static_cast<Gravity>(static_cast<unsigned int>(a) & static_cast<unsigned int>(b)); }
