...
#define TypeMetaDef(class_name, ptr) \
    Voxium::Core::Reflection::ReflectionInstance(Voxium::Core::Reflection::TypeMeta::newMetaFromName(#class_name), \
                                                 (class_name*)ptr)

#define TypeMetaDefPtr(class_name, ptr) \
    new Voxium::Core::Reflection::ReflectionInstance(Voxium::Core::Reflection::TypeMeta::newMetaFromName(#class_name), \
                                                     (class_name*)ptr)
