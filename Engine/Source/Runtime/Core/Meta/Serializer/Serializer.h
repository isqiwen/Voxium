...
namespace Voxium::Core
{
    ...
    public:
        ...
        {
            return Json {{"$typeName", Json {"*"}}, {"$context", Serializer::write(*instance)}};
        }
        ...
        static T*& readPointer(const Json& json_context, T*& instance)
        {
            ...
            std::string type_name = json_context["$typeName"].get<std::string>();
        ...
        static Json write(const Reflection::ReflectionPtr<T>& instance)
        {
            ...
            return Json {{"$typeName", Json(type_name)},
