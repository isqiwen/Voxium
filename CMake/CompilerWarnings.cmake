function(set_project_warnings project_name)
    ...
    if(NOT TARGET ${project_name})
        message(AUTHOR_WARNING "Target '${project_name}' does not exist. Cannot set warnings.")
        return()
    endif()
    ...
    elseif(target_type STREQUAL "STATIC_LIBRARY" OR
        ...
        message(AUTHOR_WARNING "Target '${project_name}' has an unknown type '${target_type}'. Cannot set warnings.")
    endif()
endfunction()
